        ...
        <div className="mt-8 space-y-6">
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white dark:bg-brand-darker text-gray-500">Or sign up with email</span>
                </div>
            </div>
            ...
            <div className="space-y-5">
                <div>
                    <label className="block text-sm font-bold text-gray-900 dark:text-gray-200 mb-2 ml-1">Full Name</label>
                    <input
                    type="text"
                    required
